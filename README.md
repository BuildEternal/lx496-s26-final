# Final Exam: Prompting and Imitative Falsehoods
**Due:** May 8, 11:59 PM

For this assignment, please complete the _problem set_ found in `final-pset.ipynb`. The problem set includes coding
...
For some of the coding problems, you will be asked to run your code (preferably on [SCC](https://scc-ondemand1.bu.edu/)). This will cause a language model from 🤗 Transformers to be evaluated on the [TruthfulQA benchmark](https://huggingface.co/datasets/EleutherAI/truthful_qa_mc) ([Lin et al., 2021](https://arxiv.org/abs/2109.07958)). When the evaluation is complete, the results will be saved as a `.csv` file in the `results` folder. Please submit the `.csv` results files for all evaluations you are asked to perform in this assignment.

For the written problems, please submit your answers in PDF format, using the filename `final-written.pdf`. Make sure to clearly mark each problem in order to minimize the chances of grading errors.

You do not need to submit anything for Problems 1c, 2a, or 2b.

You are free to use any resources to help you with this assignment, including books, websites, and AI assistants such as [TerrierGPT](https://terriergpt.bu.edu/). You are also free to collaborate with any other student or students in this class. However, you must write and submit your own answers to the problems, and merely copying another student's answer will be considered cheating on the part of both students. If you choose to collaborate, please list your collaborators at the top of your `final-written.pdf` file. If you choose to use TerrierGPT or a similar AI assistant to help you with this assignment in any way, please include a file called `final-chatgpt-logs.txt` with a full transcript of all prompts and responses used for this assignment. Your use of AI assistants cannot involve generating images or any other content that cannot be included in a `.txt` file.
...
* `final-written.pdf`
* `final-chatgpt-logs.txt` (if ChatGPT or another AI assistant is used).
...
The point values for each problem are given below. Problem 3c is worth 3 extra credit points, and the maximum possible grade on the final exam is 30 points. 

| Problem                                      | Problem Type     | Points |
|----------------------------------------------|------------------|--------|
| 1a: Understand the Evaluation Paradigms      | Written          | 3      |
| 1b: Understand the Multiple Choice Paradigms | Written          | 3      |
| 2c: Implement the MC1 Paradigm               | Code             | 4      |
| 2d: Implement Pipeline Methods               | Code             | 10     |
| 3a: Scaling Laws                             | Code and Written | 5      |
| 3b: Prompt Engineering                       | Code and Written | 5      |
| 3c: Extra Credit                             | Code and Written | 3 EC   |
| **Total**                                    |                  | **30** |
...
* at least 2 points if your code runs but fails at least one test case
...
* full points for Problems 1a and 1b if all questions are answered correctly
...
* at least 1 point if a good-faith effort (according to Yulu's and/or Sophie's judgement) has been made to answer the question
* 0 points if your answer is blank.

Partial credit may be awarded at the Yulu's and/or Sophie's discretion.

## Late Submissions and Resubmissions

Since this exam is due at the end of the semester, no late submissions will be accepted after 11:59 PM on May 8. You may resubmit your solutions as many times as you like; only the final submission will be graded. 